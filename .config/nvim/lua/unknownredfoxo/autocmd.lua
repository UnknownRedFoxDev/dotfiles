...
-- vim.api.nvim_create_user_command("SwitchBuffers", prompt_buffer_name, { range = true, nargs = "?" })
vim.api.nvim_create_user_command("SwitchBuffers", select_buffers, { range = true, nargs = "?" })
vim.api.nvim_create_user_command("FindFile", FindFile, { range = true, nargs = "?" })
...
vim.api.nvim_create_user_command("FindFirstError", FindFirstError, {})
